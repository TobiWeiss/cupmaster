 ...
 * @param question - The question to display to the user - holds the translation key (e.g. 'tournamentManagement.creation.questions.name.question')
 * @param placeholder - The placeholder text for the element - holds the translation key (e.g. 'tournamentManagement.creation.questions.name.placeholder')
 ...
 * @param explanation - An explanation for the element - holds the translation key (e.g. 'tournamentManagement.creation.questions.name.explanation')
 */
